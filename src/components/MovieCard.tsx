...
export function MovieCard({ movie }: { movie: Movie }) {
  return (
    <Card className="overflow-hidden border-2 bg-card/50 border-transparent hover:border-primary hover:bg-card transition-all duration-300 group flex flex-col">
